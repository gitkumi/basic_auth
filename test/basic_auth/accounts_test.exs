defmodule BasicAuth.AccountsTest do
  use BasicAuth.DataCase
  ...
  describe "register_user/1" do
    test "requires email, password, first_name, and last_name to be set" do
    ...
    test "validates email and password when given" do
      {:error, changeset} = Accounts.register_user(%{email: "not valid", password: "passwd"})
